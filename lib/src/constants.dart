...
// shared so every scrollable using it fades at the same rate regardless of
// its own size.
...
// 12 values are the single source of truth: whatever shade a theming pass
...
// #000000 across every theme, not theme-dependent.
class AppTheme {
  final String id;
  ...
  // tone for contrast rather than being independent inputs: onPrimary uses
  // Surface's Main, onSecondary uses Primary's Main, onSurface uses
  // Primary's Light Accent. The remaining fields are still-unnamed Material
  // placeholder grays, not theme-dependent.
